...
def main(input_saved_model_path, input_classes_path, input_image_dir_path, output_json_dir_path):
    ...
    model = OnnxModel(input_saved_model_path, classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_saved_model_path', type=str, default='~/.vaik-classification-pth-trainer/output_model/onnx/model.onnx')
